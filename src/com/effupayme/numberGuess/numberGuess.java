				...
				if (numText.getText().toString() != null) {
					try {
						...
						if (guess == randNum) {
							...
							count--;
							toast.setText(this.getString(R.string.high) + count
									+ " " + this.getString(R.string.triesLeft));
							numText.setHint(this.getString(R.string.lowerHint)
									+ " " + guess);
						} else if (guess < randNum) {
							count--;
							toast.setText(this.getString(R.string.low) + count
									+ " " + this.getString(R.string.triesLeft));
							numText.setHint(this.getString(R.string.higherHint)
									+ " " + guess);
						}

						if (count == 0) {
							toast.setDuration(Toast.LENGTH_LONG);
							toast.setText(this.getString(R.string.answer) + " "
									+ randNum + "."
									+ this.getString(R.string.newNum));
							randNum = (int) ((Math.random() * 100) + 1);
							count = 5;
							numText.setHint(this.getString(R.string.hint));
						}
